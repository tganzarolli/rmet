const taskData = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        emotion: "defiant",
        description: "insolent, bold, don\x92t care what anyone else thinks",
        sentence:
